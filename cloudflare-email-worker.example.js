...
const adminHostRouteFallbacks = new Map([
  ['/', '/admin-tools.html'],
  ['/admin', '/admin-tools.html'],
  ['/access', '/admin-tools.html'],
  ['/admin/access', '/admin-tools.html'],
  ['/supplier-access', '/admin-tools.html'],
  ['/admin/supplier-access', '/admin-tools.html'],
  ['/customer-access', '/admin-tools.html'],
  ['/admin/customer-access', '/admin-tools.html'],
  ['/customer', '/admin-tools.html'],
  ['/admin/customer', '/admin-tools.html'],
  ['/customers', '/admin-tools.html'],
  ['/admin/customers', '/admin-tools.html'],
  ['/refund', '/admin-tools.html'],
  ['/admin/refund', '/admin-tools.html'],
  ['/mail', '/admin-tools.html'],
  ['/admin/mail', '/admin-tools.html'],
  ['/chat', '/admin-tools.html'],
  ['/admin/chat', '/admin-tools.html'],
  ['/office', '/admin-tools.html'],
  ['/admin/office', '/admin-tools.html'],
  ['/marketing', '/admin-tools.html'],
  ['/admin/marketing', '/admin-tools.html'],
  ['/content', '/admin-tools.html'],
  ['/admin/content', '/admin-tools.html'],
  ['/stock', '/admin-tools.html'],
  ['/admin/stock', '/admin-tools.html'],
  ['/finance', '/admin-tools.html'],
  ['/admin/finance', '/admin-tools.html'],
